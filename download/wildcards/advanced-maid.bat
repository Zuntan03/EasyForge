...
if exist "advanced\maid-dresses-locations.txt" (
	echo https://civitai.com/models/76968?modelVersionId=81762 advanced\maid-dresses-locations.txt
	popd & exit /b 0
)
...
%PS_CMD% "try { Expand-Archive -Path advanced-maid.zip -DestinationPath advanced -Force } catch { exit 1 }"
if %ERRORLEVEL% neq 0 ( pause & popd & exit /b 1 )

echo del /Q advanced-maid.zip
del /Q advanced-maid.zip
if %ERRORLEVEL% neq 0 ( pause & popd & exit /b 1 )
